    ...
    return {
        ...
        plugins: [
            ...
            new webpack.DefinePlugin({
                ...
                'process.env.FIREBASE_DATABASE_URL': JSON.stringfy(process.env.FIREBASE_DATABASE_URL),
                ...
                'process.env.FIREBASE_API_ID': JSON.stringfy(process.env.FIREBASE_API_ID)
            })
        ],
        module: {
            rules: [{
